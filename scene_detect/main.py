...
if __name__ == '__main__':
    # resize("output.mp4", 160, -1, "resize_test.mp4", True, True)
    scene_detect()
...
# log_percent_index = int(frame_count / 100)
# last = None
# last_histogram = None
# i = 0
# for frame in clip.iter_frames():
#     if i % log_percent_index == 0:
#         print(f"{i / frame_count * 100:.0f}%")
#     # Image.fromarray(frame).save("temp.png")
#     # frame = np.array(Image.open("temp.png"))
#
#     hist = histogram(frame)
#
#     if last is not None:
#         key_frames.append(DeltaResult(delta(last_histogram, hist), i, last, frame))
#
#     last = frame
#     last_histogram = hist
#     i += 1
...
# key_frames.sort(key=lambda x: x.delta, reverse=True)
#
# print(list(map(lambda x: x.index / clip.fps, key_frames[:32])))
# print(clip.size, frame_count)
# print(i)
# print(key_frames[0].index)
#
# for i in range(10):
#     key_frame = key_frames[i]
#     data = clip.get_frame(key_frame.index / clip.fps)
#     last_data = clip.get_frame((key_frame.index - 1) / clip.fps)
#     # print(delta(last_data, data))
#     print(key_frame.delta)
#     print(key_frame.index / clip.fps)
#     print(last_data.shape)
#     print(data.shape)
#     Image.fromarray(data).save(f"{i}.png")
#     Image.fromarray(last_data).save(f"{i}_last.png")
#     # Image.fromarray(key_frame.current_frame).save(f"{i}_actual.png")
#     # Image.fromarray(key_frame.last_frame).save(f"{i}_last_actual.png")
#     # reloaded_last = np.array(Image.open(f"{i}_last_actual.png"))
#     # reloaded = np.array(Image.open(f"{i}_actual.png"))
#     # print(delta(reloaded_last, reloaded))
#     # print(reloaded_last)
#     # print(reloaded)
#
#
